...
export const WishlistHeader = () => {
  ...
  return (
    <header className="border-lightgray relative sticky top-0 z-50 w-full border-b bg-gray-50/70 backdrop-blur-sm sm:min-w-md">
        ...
        {isEditPage && (
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-blue-900 transition hover:text-blue-800 md:hidden"
            >
