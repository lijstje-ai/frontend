export const whySectionQuestions = [
  {
    id: 1,
    title: "AI cadeau suggesties",
    description:
      " Krijg slimme cadeautips gebaseerd op leeftijd, interesses en budget.",
    iconColor: "text-main-blue",
    iconBackgroundColor: "bg-main-blue/10",
    icon: (
      <svg
        className="h-6 w-6"
  ...
  },
  {
    ...
    iconBackgroundColor: "bg-main-red/10",
    icon: (
      <svg
        className="h-6 w-6"
        xmlns="http://www.w3.org/2000/svg"
...
export const howItWorksItems = [
  ...
  {
    id: 3,
    title: "Deel met familie",
    description:
      "Stuur de unieke link naar je familie en vrienden. Zij kunnen afstrepen.",
